...
// --- DRIVER 1 PINS (Left Motors) ---
const int ENA1 = 32; // Connected to P32
const int IN1 = 33;  // Connected to P33
const int IN2 = 25;  // Connected to P25
const int IN3 = 26;  // Connected to P26
const int IN4 = 27;  // Connected to P27
const int ENB1 = 14; // Connected to P14

// --- DRIVER 2 PINS (Right Motors) ---
const int ENA2 = 22; // Connected to P22
const int IN5 = 16;  // Connected to P16
const int IN6 = 17;  // Connected to P17
const int IN7 = 18;  // Connected to P18
const int IN8 = 19;  // Connected to P19
const int ENB2 = 23; // Connected to P23
...
void setup() {
  ...
  // Set default full speed for all four motors (0 to 255)
  ...
  // Map web URLs to hardware functions
